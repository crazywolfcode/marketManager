...
namespace MarketManage
{
    ...
    class ControlAttachProperty
    {
        ...
        #region IconProperty 字体图标
        /// <summary>
        /// 字体图标
        /// </summary>
        public static readonly DependencyProperty IconProperty = DependencyProperty.RegisterAttached("Icon", typeof(string), typeof(ControlAttachProperty), new FrameworkPropertyMetadata(""));
        ...
        /// 字体图标
        /// </summary>
        public static readonly DependencyProperty IconSizeProperty = DependencyProperty.RegisterAttached("IconSize", typeof(double), typeof(ControlAttachProperty), new FrameworkPropertyMetadata(12D));
        ...
        //#region LabelCornerRadius
        
        //public static readonly DependencyProperty LabelCornerRadiusProperty =
        //    DependencyProperty.Register("LabelCornerRadius", typeof(CornerRadius), typeof(ControlAttachProperty), new PropertyMetadata(null));

        //public static CornerRadius GetLabelCornerRadius(DependencyObject d)
        //{
        //    return (CornerRadius)d.GetValue(LabelCornerRadiusProperty);
        //}

        //public static void SetLabelCornerRadius(DependencyObject d, CornerRadius value)
        //{
        //    d.SetValue(LabelCornerRadiusProperty, value);
        //}
        //#endregion
        ...
        private static void ClearButtonClick(object sender, ExecutedRoutedEventArgs e)
        {
            ...
            {
                ((PasswordBox)tbox).Password = null;
